const PRESSURE_INDICATOR_SCHEMA = {
    rangeMin: { label: 'Range Min', unit: 'bar', type: 'number', default: 0 },
    rangeMax: { label: 'Range Max', unit: 'bar', type: 'number', default: 10 }
};
...
const LINE_MONITOR_SCHEMA = {
    pressureRangeMin: { label: 'Pressure Range Min', unit: 'bar', type: 'number', default: 0 },
    pressureRangeMax: { label: 'Pressure Range Max', unit: 'bar', type: 'number', default: 10 },
